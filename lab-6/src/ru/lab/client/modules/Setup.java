package ru.lab.client.modules;

import ru.lab.common.tools.Files;
import ru.lab.common.tools.FilesException;
...
public class Setup {
  ...
  public void logger() { // TODO: Save log to file
    String path = "res" + File.separator + "logging.properties"; // TODO: Properties without file
    try {
